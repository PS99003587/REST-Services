...
* The original package name 'com.ltts.Shopping Cart with Micro Services' is invalid and this project uses 'com.ltts.Shopping.Cart.with.Micro.Services' instead.
